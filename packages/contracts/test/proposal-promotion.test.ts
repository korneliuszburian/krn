...
describe("KRN proposal promotion contract", () => {
  ...
  it("parses an init eval-baseline promotion with the init-only scope", () => {
    const promotion = parseKrnProposalPromotion({
      schema_version: "krn-proposal-promotion.v1",
      kind: "krn_proposal_promotion",
      promotion_id: "promotion-init-bootstrap-eval-baseline-test",
      proposal_id: "init-bootstrap-eval-baseline-test",
      proposal_path: ".krn/proposals/init-bootstrap-eval/proposal.json",
      decision_id: "decision-init-bootstrap-eval-baseline-test",
      decision_path: ".krn/proposal-reviews/init-bootstrap-eval/decision.json",
      proposal_kind: "init_bootstrap",
      promotion_scope: "approved_init_bootstrap_only",
      apply_mode: "apply_exact_target_write",
      promotion_state: "applied",
      ...
      evidence_refs: [".krn/init/test/manifest.json"],
      source_refs: [".krn/init/test/manifest.json"],
      blocked_surfaces: ["target_overwrite", "memory_core_write", "lab_default", "lift_claim"],
      created_at: "2026-06-20T22:40:00.000Z",
      created_by: "krn init",
      interpretation_caveat:
        "This promotion applies one reviewed init eval-baseline payload only; it does not prove eval quality or broad repo bootstrap.",
    });
