...
- What is the smallest repo-bootstrap readiness proof after exact `agent_instructions`, `local_config`, `source_pointers`, `context_pointers`, `eval_baseline`, `skill_wiring`, and `policy_boundaries` apply plus target-registry simplification?
...
- Local evidence entries: LOCAL001-LOCAL061.
- Active reset claims: C059-C076.
