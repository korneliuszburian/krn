...
It reads `.krn/proposals/**/proposal.json` records, parses them as `KrnControlPlaneProposal`, rechecks source refs, reads `.krn/proposal-reviews/**/decision.json` records, and exposes review rows for a future dashboard.
...
- reviewed proposal count from `.krn/proposal-reviews`,
- invalid proposal records,
- invalid review decision records,
- conflicting review decision records,
...
- exclude proposals with one valid terminal review decision,
- surface invalid proposal files,
- surface invalid or conflicting review decision files,
...
- no promotion of approved proposals,
- no target mutation,
...
A green Pending Review view-model eval means KRN can produce typed dashboard input from local proposal-store and proposal-review decision records.
