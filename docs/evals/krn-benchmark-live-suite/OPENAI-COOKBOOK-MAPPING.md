...
| S010 | Using Goals in Codex | A long-running slice names outcome, constraints, verification, boundaries, iteration policy, and blocked state. | [docs/goals/goal-020.md](../../goals/goal-020.md), [docs/goals/goal-022.md](../../goals/goal-022.md), [docs/goals/goal-023.md](../../goals/goal-023.md). |
