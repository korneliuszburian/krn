...
- The repeat-clean stability slice keeps the typed runner policy unchanged and reruns explicit live mode so the separate stability gate can decide suite-expansion review readiness.
