...
|---|---|---|
| `valid-fixture-parses` | `docs/evals/STANDARD.md` plus source-backed contract fixtures | Machine-readable eval artifacts must parse before downstream use and include current Slice 2 and Slice 3 modules. |
