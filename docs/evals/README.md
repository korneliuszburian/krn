...
- [krn-benchmark-expanded-arena](./krn-benchmark-expanded-arena/README.md) checks whether the expanded benchmark arena has a 20-task task registry with coding-work task mix, coding-quality metrics, explicit live boundary, and registry-only caveat before live runner/scoring work.
