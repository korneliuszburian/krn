...
- [krn-mcp-transport](./krn-mcp-transport/README.md) checks whether the first Slice 3 local STDIO MCP transport lists and reads allowlisted resources without exposing tools.
