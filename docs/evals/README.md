...
- [krn-benchmark-expanded-arena](./krn-benchmark-expanded-arena/README.md) checks whether the expanded benchmark arena has a 20-task task registry, deterministic fixture scoring, coding-quality metrics, explicit live boundary, and no-lift caveat before live runner work.
